		...
		return (
			<div>
				...
				<Container>
					...
					<Demo label="transition-property-opacity"
					      className="transition transition-property-opacity hover:bg-pink hover:text-white hover:opacity-50" />
				...
				<Container>
					...
					<Demo label="transition-timing-ease-in-out"
					      className="transition transition-slower transition-timing-ease-in-out hover:bg-pink hover:text-white" />
					...
					<Demo label="transition-timing-ease-out"
					      className="transition transition-slower transition-timing-ease-out hover:bg-pink hover:text-white" />
				</Container>
